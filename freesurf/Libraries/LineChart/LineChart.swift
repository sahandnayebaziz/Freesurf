...
class LineChart: UIControl {
     ...
     */
     class Helpers {
         ...
         */
         class func UIColorFromHex(_ hex: Int) -> UIColor {
         ...
         * Lighten color.
         */
         class func lightenUIColor(_ color: UIColor) -> UIColor {
            var h: CGFloat = 0
            var s: CGFloat = 0
            var b: CGFloat = 0
            var a: CGFloat = 0
     ...
     */
     func getYValuesForXValue(_ x: Int) -> [CGFloat] {
        var result: [CGFloat] = []
     ...
     */
     func drawDataDots(_ lineIndex: Int) {
     ...
     */
     func drawAreaBeneathLineChart(_ lineIndex: Int) {
...
open class LinearScale {
    ...
    open func ticks(_ m: Int) -> (CGFloat, CGFloat, CGFloat) {
     ...
     func scale_linearTicks(_ domain: [CGFloat], m: Int) -> (CGFloat, CGFloat, CGFloat) {
        return scale_linearTickRange(domain, m: m)
    }
    
     func scale_linearTickRange(_ domain: [CGFloat], m: Int) -> (CGFloat, CGFloat, CGFloat) {
     ...
     func scaleExtent(_ domain: [CGFloat]) -> [CGFloat] {
        let start = domain[0]
        let stop = domain[domain.count - 1]
        return start < stop ? [start, stop] : [stop, start]
    }
    
     func interpolate(_ a: CGFloat, b: CGFloat) -> (_ c: CGFloat) -> CGFloat {
        var diff = b - a
     ...
     func uninterpolate(_ a: CGFloat, b: CGFloat) -> (_ c: CGFloat) -> CGFloat {
        var diff = b - a
     ...
     func bilinear(_ domain: [CGFloat], range: [CGFloat], uninterpolate: (_ a: CGFloat, _ b: CGFloat) -> (_ c: CGFloat) -> CGFloat, interpolate: (_ a: CGFloat, _ b: CGFloat) -> (_ c: CGFloat) -> CGFloat) -> (_ c: CGFloat) -> CGFloat {
